...
dat_1 = read.csv('stellar_04-25(1)_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
write.csv(dat,"stellar_processed.csv")
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  xlab("Date / time") + ylab("Sentiment") + ggtitle("Stellar Sentiment") 
########## ########## ########## ########## ##########
...
# find voulme:
########## CHANGE CODE FOR DIFFERNT DATA ##########
dat1 = read.csv('stellar_all_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  theme_minimal() + ggtitle("Stellar - Sentiment and Volume vs Price") + xlab("Date") + ylab("Price / Sentiment / Volume")
########## ########## ########## ########## ##########
