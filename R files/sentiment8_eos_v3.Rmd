...
dat_1 = read.csv('eos_04-25(1)_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
write.csv(dat,"eos_processed.csv")
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  xlab("Date / time") + ylab("Sentiment") + ggtitle("EOS Sentiment") 
########## ########## ########## ########## ##########
...
# find voulme:
########## CHANGE CODE FOR DIFFERNT DATA ##########
dat1 = read.csv('eos_all_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  theme_minimal() + ggtitle("EOS - Sentiment and Volume vs Price") + xlab("Date") + ylab("Price / Sentiment / Volume")
########## ########## ########## ########## ##########
