...
dat_1 = read.csv('ripple_04-25(1)_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
write.csv(dat,"ripple_processed.csv")
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  xlab("Date / time") + ylab("Sentiment") + ggtitle("Ripple Sentiment") 
########## ########## ########## ########## ##########
...
# find voulme:
########## CHANGE CODE FOR DIFFERNT DATA ##########
dat1 = read.csv('ripple_all_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  theme_minimal() + ggtitle("Ripple - Sentiment and Volume vs Price") + xlab("Date") + ylab("Price / Sentiment / Volume")
########## ########## ########## ########## ##########
