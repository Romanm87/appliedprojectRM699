...
dat_1 = read.csv('eth_04-25_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
write.csv(dat,"eth_processed.csv")
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  xlab("Date / time") + ylab("Sentiment") + ggtitle("Ethereum Sentiment") 
########## ########## ########## ########## ##########
...
# find voulme:
########## CHANGE CODE FOR DIFFERNT DATA ##########
dat1 = read.csv('eth_all_pred.csv')
########## ########## ########## ########## ##########
...
########## CHANGE CODE FOR DIFFERNT DATA ##########
  theme_minimal() + ggtitle("Ethereum - Sentiment and Volume vs Price") + xlab("Date") + ylab("Price / Sentiment / Volume")
########## ########## ########## ########## ##########
